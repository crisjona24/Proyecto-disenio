 ...
 * @author PC
 */
public class Equipo_Modificar extends javax.swing.JFrame {

    /**
     * Creates new form acceso
     */
    
    public Equipo_Modificar() {
        initComponents();
        ...
        modificarEquipo.setBackground(Color.lightGray);
    ...
    private void initComponents() {
        ...
        modificarEquipo.setText("Guardar y cambiar");
        getContentPane().add(modificarEquipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 360, 140, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Equipo_Modificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Equipo_Modificar().setVisible(true);
            }
        });
    }
